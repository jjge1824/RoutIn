...
public class MapasActivity extends AppCompatActivity implements OnMapReadyCallback, android.location.LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (codigoGooglePlay != ConnectionResult.SUCCESS) {
            ...
            if (dialog != null) {
                ...
                Toast.makeText(MapasActivity.this, "Error al verificar Google Play", Toast.LENGTH_LONG).show();
                finish();
            }
        }
